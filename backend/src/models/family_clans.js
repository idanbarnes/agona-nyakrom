...
const create = async (data) => {
  ...
  const { rows } = await pool.query(
    `INSERT INTO ${TABLE} 
     (name, slug, intro, history, key_contributions, original_image_path, large_image_path, medium_image_path, thumbnail_image_path, published)
