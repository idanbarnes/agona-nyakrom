...
const create = async (data) => {
  ...
  const { rows } = await pool.query(
    `INSERT INTO ${TABLE} 
     (family_clan_id, name, title, bio, tenure_start, tenure_end, is_current, original_image_path, large_image_path, medium_image_path, thumbnail_image_path)
