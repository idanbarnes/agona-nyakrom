...
function AdminAnnouncementsListPage() {
  ...
  const handleUnpublish = async (item) => {
    ...
    try {
      ...
      setSuccessMessage('Announcement unpublished.')
      fetchAnnouncements()
    } catch (error) {
      const message = error.message || 'Unable to unpublish announcement.'
      setErrorMessage(message)
      window.alert(message)
    }
  }
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground md:text-base">
              Manage announcements, drafts, and publication updates from one place.
            </p>
          </div>
          <Button
            type="button"
                  ...
                  <TableCell className="text-right whitespace-nowrap">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        ...
                        aria-label={`View ${item.title || 'announcement'}`}
                      ...
                      <Link
                        ...
                        className={neutralIconButtonClassName}
                        aria-label={`Edit ${item.title || 'announcement'}`}
                        title="Edit"
                      >
                        <EditIcon />
                      </Link>
                      ...
                      <button
                        ...
                        aria-label={`Unpublish ${item.title || 'announcement'}`}
                        title="Unpublish"
